...
QsbDoc_FileList = {{"qsb_base.lua", "(0) Basismodul"},
...
{"qsb_x_acomp.lua", "(X) Kompatibilität"},
{"addons/qsb_x_addon_1_singlebuttons.lua", "Addon (1) SingleButtons"},
{"addons/qsb_x_addon_x_template.lua", "Addon (X) TemplateAddon"},
};
