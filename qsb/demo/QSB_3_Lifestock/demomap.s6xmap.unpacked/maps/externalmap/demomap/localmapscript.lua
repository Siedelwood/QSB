...
function Mission_LoadFiles()
    ...
    if false then
        MapPath = "E:/Repositories/revision/qsb/demo/QSB_3_Lifestock/demomap.s6xmap.unpacked/" ..MapPath;
    end
    return {
        MapPath.. "script/qsb_1_guicontrol.lua",
        MapPath.. "script/qsb_2_buildingui.lua",
        MapPath.. "script/qsb_2_quest.lua",
        MapPath.. "script/qsb_3_lifestock.lua",
